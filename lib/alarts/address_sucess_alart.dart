...
class AddressSuccessAlert extends StatefulWidget {
  AddressSuccessAlert({
    super.key,
  });

  @override
  State<AddressSuccessAlert> createState() => _AddressSuccessAlertState();
}

class _AddressSuccessAlertState extends State<AddressSuccessAlert> {
  @override
